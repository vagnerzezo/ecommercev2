        ...
        <div class="container p-6 mx-auto">
            ...
            <div class="lg:flex">
                <div class="w-full -mx-6 lg:w-2/5">
                    <div class="px-6">
                        <a href="#">
                            <img class="h-9 w-auto" src="@/assets/img/logo-techz.svg" alt="">
                        </a>

                        <p class="max-w-sm mt-2 text-gray-500 ">Join 31,000+ other and never miss out
                ...
                <div class="mt-6 lg:mt-0 lg:flex-1">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                        ...
                        <div>
                            ...
                            <a href="#" class="block mt-2 text-sm text-gray-600  hover:underline">Mega
                                cloud</a>
                            <a href="#" class="block mt-2 text-sm text-gray-600  hover:underline">Aperion
                                UI</a>
                            <a href="#" class="block mt-2 text-sm text-gray-600  hover:underline">Meraki
                                UI</a>
                        </div>

                        <div>
                            <h3 class="text-gray-700 uppercase ">Contact</h3>
                            <span class="block mt-2 text-sm text-gray-600  hover:underline">+1 526 654
                                8965</span>
            ...
            <hr class="h-px my-6 bg-gray-200 border-none ">
            <div>
                <p class="text-center text-gray-500 ">© techz 2024 - All rights reserved</p>
            </div>
        </div>
    </footer>
</template>
<script>
import NewSletter from "@/components/defualt/Newsletter.vue";
export default {
    name: "PageFooter",
    components: {
        NewSletter
