<template>
  <header
    class="fixed inset-x-0 top-0 z-30 mx-auto w-full max-w-screen-md border border-gray-100 bg-white/80 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-full lg:max-w-screen-lg"
  >
    <div class="px-4">
      <div class="flex items-center justify-between">
        <div class="flex shrink-0">
          ...
          >
            <img
              class="h-6 w-auto"
              src="@/assets/img/logo-techz.svg"
              alt=""
            >
            <p class="sr-only">techz</p>
          </a>
        </div>
        <div class="hidden md:flex md:items-center md:justify-center md:gap-5">
          <div
            v-for="(cat, indice) in categories?.slice(0, 7)"
            :key="indice"
          >
            <router-link
        ...
        <div class="flex items-center justify-end gap-3">
          ...
          >
            ...
            >
              <path
                d="m8.0071 24.93a4.9958 4.9958 0 0 1 4.9929-4.93h6a4.9959 4.9959 0 0 1 4.9929 4.93 11.94 11.94 0 0 1 -15.9858 0zm12.4929-12.43a4.5 4.5 0 1 1 -4.5-4.5 4.5 4.5 0 0 1 4.5 4.5z"
                fill="none"
              />
              <path
          ...
          <button class="relative text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-300">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              height="26"
